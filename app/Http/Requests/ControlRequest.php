...
class ControlRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'acInicio.required' => 'El campo "Acuerdo de Inicio" es obligatorio.',
            'acInicio.in' => 'El campo "Acuerdo de Inicio" solo puede ser "Si" o "No".',
            'acModificacion.required' => 'El campo "Acuerdo de Modificación" es obligatorio.',
            'acModificacion.in' => 'El campo "Acuerdo de Modificación" solo puede ser "Si" o "No".',
