        ...
        const handleClick = (e) => {
            ...
            if(restoreBtn) {
                ...
                confirm(
                    ...
                    () => {
                        router.delete(route("controles.restore", id), {
                            onSuccess: () => {
                                router.reload({ only: ["controles"] });
            ...
            if(forceDelBtn) {
                ...
                confirm(
                    {
                        title: "¿Eliminar?",
                        text: "No podrás deshacer esta acción. El expediente asociado NO se eliminará",
                        confirmText: "Sí, eliminar",
                    },
                    () => {
                        router.delete(route("controles.forceDelete", id), {
                            preserveScroll: true, 
                        });
                    }
                );
        ...
        <DataTable 
            ...
            options={{ 
                ...
                columns: [
                    ...
                    { title: "Fecha de entrega del Acuerdo de conclusión y archivo", data: "feEntregaCon", visible: false},
                    ...
                    { title: "Comentarios", data: "comentarios" },
                    {
                        ...
                        render: (data, type, row) => {
                            ...
                            if (permissions.includes("editar controles")) {
                            ...
                            if (permissions.includes("eliminar controles")) {
                                if (row.estado === "Activas") {
                                    buttons += `
                                    ...
                                    buttons += `
                                        <button class="restore-btn" data-id="${row.consecutivo}">
                                        ...
                                        <button class="force-del-btn" data-id="${row.consecutivo}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
