        ...
        const handleClick = (e) => {
            ...
            if(restoreBtn) {
                ...
                confirm(
                    ...
                    () => {
                        router.delete(route("expedientes.restore", id), {
                            onSuccess: () => {
                                router.reload({ only: ["expedientes"] });
            ...
            if(forceDelBtn) {
                ...
                confirm(
                    {
                        title: "¿Eliminar?",
                        text: "No podrás deshacer esta acción. El control asociado también se eliminará",
                        confirmText: "Sí, eliminar",
                    },
                    () => {
                        router.delete(route("expedientes.forceDelete", id), {
                            preserveScroll: true, 
                        });
                    }
                );
                        ...
                        render: (data, type, row) => {
                            ...
                            if (permissions.includes("eliminar expedientes")) {
                                if (row.estado === "Activas") {
                                    ...
                                    buttons += `
                                        <button class="restore-btn" data-id="${row.numero}">
                                        ...
                                        <button class="force-del-btn" data-id="${row.numero}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
