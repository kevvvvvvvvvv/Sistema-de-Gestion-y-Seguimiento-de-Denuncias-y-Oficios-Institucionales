...
export default function Create({ auth, errors, servidores  }) {
  ...
  function store() {
    router.post("/expedientes", values);
  }
  ...
  return (
    <MainLayout auth={auth} topHeader="Registro de expedientes" insideHeader={""} backURL="/expedientes">
